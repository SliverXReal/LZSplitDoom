...
Func KILLHANGED()
;Check...
If ProcessExists("lzdoom64.exe") Then
ShellExecuteWait( '"' & $BINFOLDER & "\nircmd64.exe" & '"', "killprocess lzdoom64.exe")
EndIf
EndFunc
...
;Help Screen
Case $CmdLine[$i] == "-help"
ConsoleWrite(@CRLF & "LZSplitDoom v1.68 (64 Bit)Command Line Options" & @crlf & @crlf & "[ Split Screen Type (Required) ]" & @crlf & @crlf & "-split={FLAG}" & @crlf & @crlf & "{FLAG} values: vertical | horizontal | trih | triv | quad" & @crlf & @crlf & "Split the screen in two (vertically or horizontally), into thirds or fourths." & @crlf & @crlf & "-mirror={BOOL}" & @crlf & @crlf & "{BOOL} values: 1 | 0"  & @crlf & @crlf & "Invert Splitscreen Layout" & @crlf & @crlf & "[ Hexen Class Type ]" & @crlf & @crlf & "-p1class={FLAG}" & @crlf & "-p2class={FLAG}" & @crlf & "-p3class={FLAG}" & @crlf & "-p4class={FLAG}" & @crlf & @crlf & "{FLAG} values: fighter | cleric | mage" & @crlf & @crlf & "Set Player Classes. Values are ignored by LZDoom if not a Hexen based game."  & @crlf & @crlf & "[ Reset Config ]" & @crlf & @crlf & "-resetconfig"  & @crlf & @crlf & "Wipe Player/Launcher configs to be rebuilt at next run." & @crlf & @crlf & "[ Example Usage ]" & @crlf & @crlf & "[ 2 Player Hexen Deathmatch ]" & @crlf & "lzsplitdoom64.exe -split=vertical -p1class=mage -p2class=cleric -iwad hexen.wad -deathmatch -nomonsters" & @crlf & @crlf & "[ 4 Player Doom 2 + Brutal Doom Coop ]" & @crlf & "lzsplitdoom64.exe -split=quad -mirror=0 -iwad doom2.wad -file brutaldoom.pk3" & @crlf)
Exit
EndSelect
Next
...
ConsoleWrite(@crlf & "LZSplitDoom - Error"  & @crlf & @crlf & "Split switch must be defined!" & @crlf & @crlf & "[ Examples ]" & @crlf & @crlf & "-split=horizontal" & @crlf & "-split=vertical" & @crlf & "-split=trih" & @crlf & "-split=triv" & @crlf & "-split=quad" & @crlf & @crlf & "Type lzsplitdoom64.exe -help for more information." & @crlf)
Exit
EndIf
...
ConsoleWrite(@crlf & "LZSplitDoom - Error" & @crlf & @crlf & "IWAD switch must be defined!" & @crlf & @crlf & "[ Example ]" & @crlf & @crlf & "-iwad heretic.wad" & @crlf & @crlf & "Type lzsplitdoom64.exe -help for more information." & @crlf)
Exit
EndIf
...
Global $Form1_1 = GUICreate("LZSplitDoom v1.68 (64 Bit)", $width, $height, (@DesktopWidth / 2) - ($width / 2), (@DesktopHeight / 2) - ($height / 2))
...
If $MIRROR = "0" Then
Global $Graphic1 = GUICtrlCreatePic ($BINFOLDER & "\" & $SPLITMODE & "64.gif", 304, 64, 250, 181)
Else
Global $Graphic1 = GUICtrlCreatePic ($BINFOLDER & "\" & $SPLITMODE & "64m.gif", 304, 64, 250, 181)
EndIf
...
RegWrite("HKEY_CURRENT_USER\Software\Microsoft\Windows NT\CurrentVersion\AppCompatFlags\Layers", $BINFOLDER & "\lzdoom64.exe", "REG_SZ", "HIDPIAWARE")
...
;Player_1
Global $CLIENT1 = Run('"' & $BINFOLDER & "\lzdoom64.exe" & '" ' & $PLAYER1CLI)
Global $hWnd = WinWait("LZDoom ", "Waiting")
WinSetTitle($hWnd, "", "LZSplitDoom - Player 1")

;Player_2
Global $CLIENT2 = Run('"' & $BINFOLDER & "\lzdoom64.exe" & '" ' & $PLAYER2CLI)
Global $hWnd = WinWait("LZDoom ", "Contacting")
WinSetTitle($hWnd, "", "LZSplitDoom - Player 2")

;Player_3
Global $CLIENT3 = Run('"' & $BINFOLDER & "\lzdoom64.exe" & '" ' & $PLAYER3CLI)
Global $hWnd = WinWait("LZDoom ", "Contacting")
WinSetTitle($hWnd, "", "LZSplitDoom - Player 3")

;Player_4
Global $CLIENT4 = Run('"' & $BINFOLDER & "\lzdoom64.exe" & '" ' & $PLAYER4CLI)
Global $hWnd = WinWait("LZDoom ", "Contacting")
...
;Hide Taskbar...
ShellExecuteWait( '"' & $BINFOLDER & "\nircmd64.exe" & '"', "win hide class Shell_TrayWnd")

;Strip window borders of LZDoom instances.
ShellExecuteWait( '"' & $BINFOLDER & "\nircmd64.exe" & '"', "win -style process lzdoom64.exe 0x00C40000")

;Set vertical or horizontal split screen for 2 players or quad split for 4 players.
If ($SPLITMODE="Quad" And $MIRROR=0) Then
ShellExecuteWait( '"' & $BINFOLDER & "\nircmd64.exe" & '"', "win setsize process /" & $CLIENT1 & " 0 0 " & $HalfWidth & " " & $HalfHeight)
ShellExecuteWait( '"' & $BINFOLDER & "\nircmd64.exe" & '"', "win setsize process /" & $CLIENT2 & " " & $VertOffsetWidth & " 0 " & $HalfWidth & " " & $HalfHeight)
ShellExecuteWait( '"' & $BINFOLDER & "\nircmd64.exe" & '"', "win setsize process /" & $CLIENT3 & " 0 " & $VertOffsetHeight & " " & $HalfWidth & " " & $HalfHeight)
ShellExecuteWait( '"' & $BINFOLDER & "\nircmd64.exe" & '"', "win setsize process /" & $CLIENT4 & " " & $HorOffsetWidth & " " & $VertOffsetHeight & " " & $HalfWidth & " " & $HalfHeight)
EndIf

If ($SPLITMODE="Quad" And $MIRROR=1) Then
ShellExecuteWait( '"' & $BINFOLDER & "\nircmd64.exe" & '"', "win setsize process /" & $CLIENT1 & " " & $VertOffsetWidth & " 0 " & $HalfWidth & " " & $HalfHeight)
ShellExecuteWait( '"' & $BINFOLDER & "\nircmd64.exe" & '"', "win setsize process /" & $CLIENT2 & " 0 0 " & $HalfWidth & " " & $HalfHeight)
ShellExecuteWait( '"' & $BINFOLDER & "\nircmd64.exe" & '"', "win setsize process /" & $CLIENT3 & " " & $HorOffsetWidth & " " & $VertOffsetHeight & " " & $HalfWidth & " " & $HalfHeight)
ShellExecuteWait( '"' & $BINFOLDER & "\nircmd64.exe" & '"', "win setsize process /" & $CLIENT4 & " 0 " & $VertOffsetHeight & " " & $HalfWidth & " " & $HalfHeight)
EndIf

If ($SPLITMODE="TriH" And $MIRROR=0) Then
ShellExecuteWait( '"' & $BINFOLDER & "\nircmd64.exe" & '"', "win setsize process /" & $CLIENT1 & " 0 0 " & $FullWidth & " " & $HalfHeight)
ShellExecuteWait( '"' & $BINFOLDER & "\nircmd64.exe" & '"', "win setsize process /" & $CLIENT2 & " 0 " & $HorOffsetHeight & " " & $HalfWidth & " " & $HalfHeight)
ShellExecuteWait( '"' & $BINFOLDER & "\nircmd64.exe" & '"', "win setsize process /" & $CLIENT3 & " " & $HorOffsetWidth & " " & $VertOffsetHeight & " " & $HalfWidth & " " & $HalfHeight)
EndIf

If ($SPLITMODE="TriH" And $MIRROR=1) Then
ShellExecuteWait( '"' & $BINFOLDER & "\nircmd64.exe" & '"', "win setsize process /" & $CLIENT1 & " 0 " & $VertOffsetHeight & " " & $FullWidth & " " & $HalfHeight)
ShellExecuteWait( '"' & $BINFOLDER & "\nircmd64.exe" & '"', "win setsize process /" & $CLIENT2 & " 0 0 " & " " & $HalfWidth & " " & $HalfHeight)
ShellExecuteWait( '"' & $BINFOLDER & "\nircmd64.exe" & '"', "win setsize process /" & $CLIENT3 & " " & $HorOffsetWidth & " 0 " & $HalfWidth & " " & $HalfHeight)
EndIf

If ($SPLITMODE="TriV" And $MIRROR=0) Then
ShellExecuteWait( '"' & $BINFOLDER & "\nircmd64.exe" & '"', "win setsize process /" & $CLIENT1 & " 0 0 " & $HalfWidth & " " & $FullHeight)
ShellExecuteWait( '"' & $BINFOLDER & "\nircmd64.exe" & '"', "win setsize process /" & $CLIENT2 & " " & $VertOffsetWidth & " 0 " & $HalfWidth & " " & $HalfHeight)
ShellExecuteWait( '"' & $BINFOLDER & "\nircmd64.exe" & '"', "win setsize process /" & $CLIENT3 & " " & $HorOffsetWidth & " " & $VertOffsetHeight & " " & $HalfWidth & " " & $HalfHeight)
EndIf

If ($SPLITMODE="TriV" And $MIRROR=1) Then
ShellExecuteWait( '"' & $BINFOLDER & "\nircmd64.exe" & '"', "win setsize process /" & $CLIENT1 & " " & $HorOffsetWidth & " 0 " & $HalfWidth & " " & $FullHeight)
ShellExecuteWait( '"' & $BINFOLDER & "\nircmd64.exe" & '"', "win setsize process /" & $CLIENT2 & " 0 0 " & $HalfWidth & " " & $HalfHeight)
ShellExecuteWait( '"' & $BINFOLDER & "\nircmd64.exe" & '"', "win setsize process /" & $CLIENT3 & " 0 " & $VertOffsetHeight & " " & $HalfWidth & " " & $HalfHeight)
EndIf
...
ShellExecuteWait( '"' & $BINFOLDER & "\nircmd64.exe" & '"', "win setsize process /" & $CLIENT1 & " 0 0 " & $HalfWidth & " " & $FullHeight)
ShellExecuteWait( '"' & $BINFOLDER & "\nircmd64.exe" & '"', "win setsize process /" & $CLIENT2 & " " & $VertOffsetWidth & " 0 " & $HalfWidth & " " & $FullHeight)
EndIf

If ($SPLITMODE="VERTICAL" And $MIRROR=1) Then
ShellExecuteWait( '"' & $BINFOLDER & "\nircmd64.exe" & '"', "win setsize process /" & $CLIENT1 & " " & $VertOffsetWidth & " 0 " & $HalfWidth & " " & $FullHeight)
ShellExecuteWait( '"' & $BINFOLDER & "\nircmd64.exe" & '"', "win setsize process /" & $CLIENT2 & " 0 0 " & $HalfWidth & " " & $FullHeight)
EndIf

If ($SPLITMODE="HORIZONTAL" And $MIRROR=0) Then
ShellExecuteWait( '"' & $BINFOLDER & "\nircmd64.exe" & '"', "win setsize process /" & $CLIENT1 & " 0 0 " & $FullWidth & " " & $HalfHeight)
ShellExecuteWait( '"' & $BINFOLDER & "\nircmd64.exe" & '"', "win setsize process /" & $CLIENT2 & " 0 " & $HorOffsetHeight & " " & $FullWidth & " " & $HalfHeight)
EndIf

If ($SPLITMODE="HORIZONTAL" And $MIRROR=1) Then
ShellExecuteWait( '"' & $BINFOLDER & "\nircmd64.exe" & '"', "win setsize process /" & $CLIENT1 & " 0 " & $HorOffsetHeight & " " & $FullWidth & " " & $HalfHeight)
ShellExecuteWait( '"' & $BINFOLDER & "\nircmd64.exe" & '"', "win setsize process /" & $CLIENT2 & " 0 0 " & $FullWidth & " " & $HalfHeight)
...
ShellExecute( '"' & $BINFOLDER & "\nircmd64.exe" & '"', "win activate process /" & $CLIENT1)
...
;Restore Taskbar
ShellExecute( '"' & $BINFOLDER & "\nircmd64.exe" & '"', "win show class Shell_TrayWnd")
...
If $MIRROR = "1" Then
GUICtrlSetImage ($Graphic1, $BINFOLDER & "\" & $MODE & "64m.gif")
Else
GUICtrlSetImage ($Graphic1, $BINFOLDER & "\" & $MODE & "64.gif")
EndIf
